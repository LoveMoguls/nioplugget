...
- [x] **CONT-01**: System har färdiga övningspass för Biologi (Ekologi, Kroppen, Genetik, Cellen)
- [x] **CONT-02**: System har färdiga övningspass för Samhällskunskap (Demokrati, Rättigheter, Ekonomi, Lag & rätt)
- [x] **CONT-03**: System har färdiga övningspass för Matematik (Algebra, Geometri, Statistik, Samband & förändring)
- [x] **CONT-04**: Varje ämnesområde har 3-5 övningar med stigande svårighetsgrad
- [x] **CONT-05**: Varje övning har en skräddarsydd system-prompt som följer Skolverkets centrala innehåll

### AI Dialog

- [x] **CHAT-01**: Elev kan starta ett övningspass genom att välja ämne → ämnesområde → övning
- [x] **CHAT-02**: AI-läraren ställer ledande frågor och ger aldrig direkta svar
- [x] **CHAT-03**: AI-dialogen streamar svar i realtid via SSE
- [x] **CHAT-04**: AI:n anpassar nivån baserat på elevens svar
- [x] **CHAT-05**: AI:n håller sig strikt till ämnet och styr tillbaka vid avvikelser
- [x] **CHAT-06**: Elev kan avsluta ett pass manuellt
- [x] **CHAT-07**: Alla meddelanden sparas i databasen per session
- [x] **CHAT-08**: Konversationshistoriken trunkeras för att hantera token-kostnader
...
- [x] **UI-01**: Mobilanpassad (mobile-first) responsiv design
- [x] **UI-02**: Rent, lugnt UI utan distraktioner
- [x] **UI-03**: Landningssida med info om tjänsten och registrering/inloggning
- [x] **UI-04**: Chattvy med tydlig meddelandehistorik och input-fält
